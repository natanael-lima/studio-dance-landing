  ...
  return (
    <section className="hero-container" id='home'>
      ...
      <img 
        src={danceBanner} 
        alt="Dancer" 
        className="hero-image absolute inset-0 w-full h-full object-cover" // Clase CSS para la imagen del perro
      />   
      {/* Contenido central */}
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 flex space-x-4 z-10 lg:left-1/4">
