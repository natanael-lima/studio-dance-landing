  ...
  return (
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
            ...
            <form className="mt-6">
                ...
                <input
                    className="w-full rounded-full border-gray-200 bg-gray-100 p-4 pe-32 text-sm font-medium text-black"
                    id="email"
                    type="email"
                ...
                <button
                    className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-rose-400 px-5 py-3 text-sm font-medium text-white transition hover:bg-rose-500"
                >
                    Subscribe
                </button>
                </div>
            ...
            <p className="text-center text-xs/relaxed text-gray-500">
                © MM Studio Company 2022. All rights reserved.

                <br />

                by
                <a href="https://www.linkedin.com/in/natanael-dev/" className="text-gray-700 underline transition hover:text-gray-700/75"> Natanael Lima</a>.
            </p>
            </div>
        </div>
        </footer>
